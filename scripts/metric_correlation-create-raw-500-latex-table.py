...
def get_all_lang_correlations(mc, baseline, gold, system):
    ...
    print(sig_txt + '{%.2f} ' % system_results['de-en'][0]), end=' ')
...
def write_table(metric):
    ...
    print(r' & ', end=' ')
    get_all_lang_correlations(mcsys, baseline + '-seglevel.500.tsv', gold_seg, baseline + '-seglevel.500.tsv')
    print(r'\\')

    # Paraphrase baselines
    print(r'\midrule')
    print(r'\multirow{3}{*}{\pbox{1.3cm}{Baselines (+5)}}')
    print(r'\beam & ', end=' ')
    ...
    print(r' & ', end=' ')
    get_all_lang_correlations(mcseg, baseline + '-seglevel.500.tsv', gold_seg, system_prefix + '/sampled/par' + metric + '-sampeled.num=5-seglevel.500.tsv')

    # Diversity (+1)
    print(r'\midrule')
    print(r'\multirow{2}{*}{\pbox{1.3cm}{Diversity (+1)}}')
    print(r'\laser & ', end=' ')
    ...
    # Diversity (+5)
    print(r'\midrule')
    print(r'\multirow{2}{*}{\pbox{1.3cm}{Diversity (+5)}}')
    print(r'\laser & ', end=' ')
    ...
    # Output-specific (+1)
    print(r'\midrule')
    print(r'\multirow{2}{*}{\pbox{1.3cm}{Output-specific (+1)}}')
    print(r'\laser & ', end=' ')
