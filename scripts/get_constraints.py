...
"""
Builds constraints by taking the system outputs and finding n-grams that
are preferred by the systems and not in the reference.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scope', '-s', type=float, default=-10, help='human score threshold for including systems')
    parser.add_argument('--threshold', '-t', type=float, default=2, help="number (if > 1) or percent (if <= 1) of systems that must agree")
