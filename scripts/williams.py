...
def williams_test(r12, r13, r23, n):
    ...
    if r12 < r13:
        ...
        #print(K)
        #print(2*K*(n-1)/(n-3) + (((r12+r13)**2)/4)*((1-r23)**3))
...
#        print("")
#        print("    r12 correlation( Human, metric A ) : " + str(args.r12))
#        print("    r13 correlation( Human, metric B ) : " + str(args.r13))
#        print("    r23 correlation( metric A, metric B) : " + str(args.r23))
#        print("")
#        print("    Sample size: {args.n}")
#        print("")
        print("P-value: " + '{:.72f}'.format(float(p)))
        print(p)
#        print("-----------------------------------------")
